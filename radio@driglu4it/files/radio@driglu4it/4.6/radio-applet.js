...
function _getEventHandlerActor() {
    if (!eventHandlerActor) {
        ...
        src_uiGroup.add_actor(eventHandlerActor);
        // We connect to 'event' rather than 'captured-event' because the capturing phase doesn't happen
        // when you've grabbed the pointer.
        // @ts-ignore
        eventHandlerActor.connect('event', () => currentDraggable === null || currentDraggable === void 0 ? void 0 : currentDraggable._onEvent(actor, event));
    }
...
class _Draggable {
    ...
    constructor(actor) {
        ...
        this._actorDestroyed = null;
        this._updateHoverId = undefined;
    ...
    startDrag(stageX, stageY, time) {
        ...
        if (this.actor._delegate !== undefined) {
            ...
            if (!scaledHeight)
                scaledHeight = 0;
            this._dragActor.set_scale(scaledWidth / this.actor.width, scaledHeight / this.actor.height);
    ...
    _maybeStartDrag(event) {
        ...
        // @ts-ignore
        let threshold = src_Settings.get_default().gtk_dnd_drag_threshold;
    ...
    _updateDragHover() {
        ...
        if (this.recentDropTarget) {
            ...
            // @ts-ignore
            if (x < allocation.x1 || x > allocation.x2 || y < allocation.y1 || y > allocation.y2 && ((_b = (_a = this.recentDropTarget) === null || _a === void 0 ? void 0 : _a._delegate) === null || _b === void 0 ? void 0 : _b.handleDragOut)) {
                //@ts-ignore
                this.recentDropTarget._delegate.handleDragOut();
                this.recentDropTarget = null;
            }
        }
        let stage = (_c = this._dragActor) === null || _c === void 0 ? void 0 : _c.get_stage();
        if (!stage) {
            return;
        }
        ...
        while (target) {
            ...
            if (target._delegate && target._delegate.handleDragOver && this.actor._delegate) {
                ...
                // @ts-ignore
                result = target._delegate.handleDragOver(this.actor._delegate, this._dragActor, targX, targY, 0);
                if (result == DragMotionResult.MOVE_DROP || result == DragMotionResult.COPY_DROP) {
                    // @ts-ignore
                    if (target._delegate.handleDragOut)
                        this.recentDropTarget = target;
                    break;
                }
            }
    ...
    _dragActorDropped(event) {
        ...
        while (target) {
            ...
            if (target._delegate && target._delegate.acceptDrop) {
                ...
                // @ts-ignore
                if (target._delegate.acceptDrop(this.actor._delegate, this._dragActor, targX, targY, event.get_time())) {
                    // If it accepted the drop without taking the actor,
                    // handle it ourselves.
                    if (!((_b = this._dragActor) === null || _b === void 0 ? void 0 : _b.is_finalized()) && ((_c = this._dragActor) === null || _c === void 0 ? void 0 : _c.get_parent()) === src_uiGroup) {
    ...
    _getRestoreLocation() {
        ...
        if (this._dragActorSource && this._dragActorSource.visible) {
            ...
            scale = ((_a = this._dragActor) === null || _a === void 0 ? void 0 : _a.width) || 0 / (sourceScaledWidth || 0);
        }
    ...
    _restoreDragActor(eventTime) {
        ...
        (_a = this._dragActor) === null || _a === void 0 ? void 0 : _a.set_position(restoreX || 0, restoreY || 0);
        (_b = this._dragActor) === null || _b === void 0 ? void 0 : _b.set_scale(restoreScale || 0, restoreScale || 0);
        if (this._dragActor) {
