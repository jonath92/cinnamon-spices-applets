...
const proxy = imports.gi.Gio.makeProxyWrapper<Test>('iwas')

// const dbus = proxy(imports.gi.Gio.DBus.session, 'org.freedesktop.DBus', '/org/freedesktop/DBus')



const dbus = proxy(imports.gi.Gio.DBus.session, 'iwas', 'iwas')
